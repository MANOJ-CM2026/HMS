        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              ...
              management system. From patient records to pharmacy inventory,
              manage everything efficiently in one place.
            </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-6">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="h-24 bg-secondary/50 rounded-lg border border-border"
                    ></div>
                  ))}
                </div>
              </div>
          ...
          {[
            {
              ...
              description:
                "Comprehensive patient profiles, medical history, and appointment scheduling",
            },
            {
              icon: Beaker,
              title: "Lab Management",
              description:
                "Track lab tests, results, and generate reports with automated workflows",
            },
            {
              icon: Pill,
              title: "Pharmacy System",
              description:
                "Manage medicine inventory, stock levels, and expiry dates efficiently",
            },
            {
              icon: BarChart3,
            ...
            },
            {
              ...
              description:
                "Live notifications and instant updates across all departments",
            },
          ].map((feature, idx) => {
              ...
              {[
                {
                  ...
                  description:
                    "Optimized performance for instant data retrieval and smooth operations",
                },
                {
                  icon: Shield,
                  title: "Secure & Compliant",
                  description:
                    "Meets all healthcare compliance standards and data protection regulations",
                },
                {
                  icon: Users,
                  title: "User Friendly",
      ...
      >
        <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-3xl p-12 md:p-16">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join hundreds of healthcare facilities using our system to improve
